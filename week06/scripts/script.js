$(document).ready(function () {
  ...
  function weatherFunction(searchTerm) {
    ...
    $.ajax({
      type: "GET",
      url: "https://api.openweathermap.org/data/2.5/weather?q=" + searchTerm + "&appid=81e7d3dd142281cf3a0b21c4bdbb20f4",
      ...
      $.ajax({
        type: "GET",
        url: "https://api.openweathermap.org/data/2.5/uvi?appid=81e7d3dd142281cf3a0b21c4bdbb20f4&lat=" + lat + "&lon=" + lon,
  ...
  function weatherForecast(searchTerm) {
    $.ajax({
      type: "GET",
      url: "https://api.openweathermap.org/data/2.5/forecast?q=" + searchTerm + "&appid=81e7d3dd142281cf3a0b21c4bdbb20f4&units=imperial",
